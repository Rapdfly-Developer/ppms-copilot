...
// Three calls only, entirely synthetic records; never prints environment secrets.
...
it.skipIf(process.env.VI_GH_LIVE !== "1")("VI(g): three synthetic live sanity calls", async () => {
