...
export const ERROR_CODES = {
  ...
  DIAGNOSIS_COMPARISON_STRUCTURE_INVALID: "DIAGNOSIS_COMPARISON_STRUCTURE_INVALID",
...
export const USER_MESSAGES: Record<ErrorCode, string> = {
  ...
  AI_REQUEST_TOO_LARGE: "This record is too large for the AI service's current limits. Please contact your administrator.",
  ...
  EXAM_GUIDANCE_STRUCTURE_INVALID:
    "AI response did not follow the required exam guidance format. Please try again.",
  REFRACTIVE_GUIDANCE_STRUCTURE_INVALID:
  ...
  DIAGNOSIS_COMPARISON_STRUCTURE_INVALID:
    "AI response did not follow the required diagnosis comparison format. Please try again.",
